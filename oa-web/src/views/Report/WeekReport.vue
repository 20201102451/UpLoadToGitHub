...
<script>
import testData from "@/views/Report/Week.json"
export default {
    data() {
        return {
            DataList: testData,
            CardClass: {
                "el-icon-success":true, //通过审核
                "el-icon-warning": false, //未提交
                "el-icon-s-promotion": false, //等待审核
                "el-icon-error": false, //未通过
                "success": true,
                "warning": false,
                "danger": false
            },
